package com.hk.arcsoft.enums;

public enum ArcSoftErrorCodeEnum {
    MOK(0,"成功"),
    UNKNOWN(1,"未知错误"),
    ...
    private String description;
     ...
     ArcSoftErrorCodeEnum(Integer code, String description){
        this.code=code;
    ...
    public static ArcSoftErrorCodeEnum getDescriptionByCode(Integer code){
        for(ArcSoftErrorCodeEnum arcSoftErrorCodeEnum : ArcSoftErrorCodeEnum.values()){
            if(code.equals(arcSoftErrorCodeEnum.getCode())){
                return arcSoftErrorCodeEnum;
            }
        }
        return  ArcSoftErrorCodeEnum.UNKNOWN;
    }
